...
// Перевірка: чи є хоч якийсь контент для основного блоку
$has_main_info = $title || $desc_1 || $desc_2 || $list_title || $list_items || $bottom_text;
$has_service_list = $list_title || $list_items;
...
// Перевірка: чи є контент для блоку "Показання"
$has_indications = $ind_title || $ind_subtitle || $ind_text_1 || $ind_text_2 || $ind_gallery;

// Advantages Fields
$adv_title = get_field('service_advantages_title');
$adv_list = get_field('service_advantages_list');

// Перевірка: чи є контент для блоку "Переваги"
$has_advantages = $adv_title || $adv_list;
...
<section class="service-info">
    <div class="container">
        ...
        <div class="service-info__content">
            ...
            <?php if ($has_main_info): ?>
                <div id="service-info" class="service-info__block">
                    <?php if ($title): ?>
            ...
            <?php if ($has_indications): ?>
                <div id="indications" class="service-indications">
            ...
            <?php if ($has_advantages): ?>
                <div id="advantages" class="service-advantages">
                    <?php if ($adv_title): ?>
